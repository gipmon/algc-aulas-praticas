/*******************************************************************************
 ...
 Programa gráfico de simulação da funcionalidade do TDA Polinómio
  ...
  do
  {
    ...
    switch (Option)
    {
        ...
        case 6 :  ReadPolyIndex (&Poly1, "primeiro polinomio");
                  ...
                  {
                    if (Equals) printf("\e[25;1f| \e[1mOs polinomios %d e %d sao iguais", Poly1, Poly2);
                    else printf("\e[25;1f| \e[1mOs polinomios %d e %d nao sao iguais", Poly1, Poly2);
...
void Menu (void)
{
  ...
  printf("\e[14;1f| 10 - Apagar um polinomio         | Poly  9 =                                                                             |\n");
  printf("\e[15;1f|  0 - Terminar o programa         | Poly 10 =                                                                             |\n");
  printf("\e[16;1f|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~| Poly 11 =                                                                             |\n");
  printf("\e[17;1f| Opcao ->                         | Poly 12 =                                                                             |\n");
  printf("\e[18;1f~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
...
void ReadPolyIndex (int *pnp, char *pmsg)
{
  ...
  do
  {
    *pnp = -1;
    ...
    printf("\e[21;%df", 17+MsgLen); scanf ("%d", pnp);
    scanf ("%*[^\n]"); scanf ("%*c");
...
int ActivePoly (PtPoly ppolyarray[], int pnpoly)
{
  ...
  if (ppolyarray[pnpoly] != NULL)
  {
    do
    {
      printf("\e[1m\e[25;1f| O polinomio %d ja existe!                     ", pnpoly);
...
int NotActivePoly (PtPoly ppolyarray[], int pnpoly)
{
  if (ppolyarray[pnpoly] == NULL)
  {
    printf("\e[1m\e[25;1f| O polinomio %d nao existe!                     ", pnpoly);
    printf("\e[0m\e[26;1f| Prima uma tecla para continuar ");
    scanf ("%*[^\n]"); scanf ("%*c");
    return 1;
  }
...
{
  printf("\e[25;1f| %s de polinomios nao foi efectuada devido a -> \e[1m%s", pmsg, PolyErrorMessage ());
  printf("\e[0m\e[26;1f| Prima uma tecla para continuar ");
  scanf ("%*[^\n]"); scanf ("%*c");
}
...
PtPoly ReadPoly (void)
{
  ...
  do
  {
    printf("\e[21;1f| Grau do polinomio ->                               ");
    printf("\e[21;24f"); scanf ("%d", &Degree);
    scanf ("%*[^\n]"); scanf ("%*c");
  ...
  for (I = 0; I <= Degree; I++)
  {
    printf("\e[21;1f| Coeficiente x^%1d ->                               ", I);
    printf("\e[21;22f"); scanf ("%lf", &Coef);
    scanf ("%*[^\n]"); scanf ("%*c");
...
void ChangePoly (PtPoly ppol)
{
  ...
  do
  {
    do
    {
      printf("\e[21;1f| Indice do coeficiente do polinomio ->                               ");
      printf("\e[21;41f"); scanf ("%d", &Ind);
      scanf ("%*[^\n]"); scanf ("%*c");
    } while (Ind < 0 || Ind > Degree);

    printf("\e[21;1f| Coeficiente x^%1d ->                               ", Ind);
    printf("\e[21;22f"); scanf ("%lf", &Coef);
    scanf ("%*[^\n]"); scanf ("%*c");
    ...
    do
    {
      printf("\e[21;1f| Deseja alterar mais algum coeficiente do polinomio (s/n)?           ");
      printf("\e[21;61f"); scanf ("%c", &Character); Character = tolower (Character);
      scanf ("%*[^\n]"); scanf ("%*c");
    } while (Character != 'n' && Character != 's');
  } while (Character == 's');
}
